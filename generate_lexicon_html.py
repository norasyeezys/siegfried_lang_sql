#!/usr/bin/env python3
"""
Generate a static HTML lexicon view from siegfried_lang.db.
Stdlib only. Run:
...
def main():
    ...
    print(f"wrote {out_path} with {len(words)} word cards")
